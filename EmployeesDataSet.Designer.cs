...
namespace SqlServerAndStruct {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class СотрудникиDataTable : global::System.Data.TypedTableBase<СотрудникиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public СотрудникиRow AddСотрудникиRow(string Имя, string Фамилия, string Должность, int ГодРождения, int Зарплата) {
            ...
            private void InitClass() {
                ...
                this.columnГодРождения = new global::System.Data.DataColumn("ГодРождения", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class СотрудникиRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public int ГодРождения {
                get {
                    try {
                        return ((int)(this[this.tableСотрудники.ГодРожденияColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'ГодРождения\' в таблице \'Сотрудники\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableСотрудники.ГодРожденияColumn] = value;
                }
            }
            ...
            public bool IsГодРожденияNull() {
                return this.IsNull(this.tableСотрудники.ГодРожденияColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetГодРожденияNull() {
                this[this.tableСотрудники.ГодРожденияColumn] = global::System.Convert.DBNull;
            }
...
namespace SqlServerAndStruct.EmployeesDataSetTableAdapters {
    ...
    public partial class СотрудникиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Сотрудники] ([Имя], [Фамилия], [Должность], [ГодРождения], [За" +
                "рплата]) VALUES (@Имя, @Фамилия, @Должность, @ГодРождения, @Зарплата)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ГодРождения", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ГодРождения", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SqlServerAndStruct.Properties.Settings.Default.EmployeesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Имя, Фамилия, Должность, ГодРождения, Зарплата FROM dbo.Сотрудники";
        ...
        public virtual int Fill(EmployeesDataSet.СотрудникиDataTable dataTable) {
        ...
        public virtual EmployeesDataSet.СотрудникиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EmployeesDataSet.СотрудникиDataTable dataTable = new EmployeesDataSet.СотрудникиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EmployeesDataSet.СотрудникиDataTable dataTable) {
        ...
        public virtual int Insert(string Имя, string Фамилия, string Должность, global::System.Nullable<int> ГодРождения, global::System.Nullable<int> Зарплата) {
            if ((Имя == null)) {
            ...
            if ((ГодРождения.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((int)(ГодРождения.Value));
            }
            else {
